<?php
	...
	$statistics = pageList($table,$where,'no desc',500,99910,$param['page'],$pagingTags);
...
//                ->setCellValue('F1', '오픈일');
    ...
    $sheetIndex->setCellValue('A'.($bora+2),$statisticsItem['no'])
					  ->setCellValue('B'.($bora+2),$statisticsItem['user_ip'])	
					  ->setCellValue('C'.($bora+2),$statisticsItem['refferer'])
					  ->setCellValue('D'.($bora+2),$statisticsItem['create_date']);
